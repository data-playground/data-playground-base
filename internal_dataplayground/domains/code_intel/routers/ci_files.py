# routers/ci_files.py
"""
Code Intelligence — Single-File Operations
...
Multi-file batch Airflow triggers (POST .../batch/narrate|comment|improve)
live in ci_batch.py (WO#24 Part B) — split out as a distinct concern from
these inline, single-file agent calls.
"""
